                ...
                <div className="flex flex-col items-center justify-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] dark:text-[#EDEDEC]">
                    <div className="max-w-2xl space-y-6 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Volunteer Hub is a community platform where anyone
                            can discover and share volunteering opportunities.
                            Whether you want to help a local organisation or
                            start your own project, this is the place to connect
                            with people who care.
                        </p>

                        <p className="text-gray-600 dark:text-gray-400">
                            You can browse all current volunteering offers on
                            the{' '}
                            <Link
                                href={homepage()}
